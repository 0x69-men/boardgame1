    ...
    let n,
        ...
        b = function () {
            for (var r = function (r, n) {
                ...
                var n = r[5], t = n > 0 && r[4] == n && r[3] == 3 * n && r[2] == n && r[1] == n
                return (t && r[6] >= 4 * n && r[0] >= n ? 1 : 0) + (t && r[0] >= 4 * n && r[6] >= n ? 1 : 0)
            }, o = 0, f = e * e, i = 0, u = e; u--;) {
                for (var c = [0, 0, 0, 0, 0, 0, 0], s = [0, 0, 0, 0, 0, 0, 0], l = !1, g = !1, d = 0, m = 0, p = e;
                     p--;) {
                    a[u][p] == l ? 5 == ++d ? o += 3 : d > 5 && o++ : (r(d, c), o += 40 * t(c), d = 1, l =
                        a[u][p]), a[p][u] == g ? 5 == ++m ? o += 3 : m > 5 && o++ : (r(m, s), o += 40 * t(s), m = 1, g =
                        a[p][u])
                    var C = a[u][p]
        ...
        O = function () {
            ...
            for (var t = function () {
                var r = []
                if (n > 1) {
                    for (var t = 2 + (n / 7 | 0), o = 32 == n ? 26 : 2 * v((e - 13) / (2 * t - 2)); t--;) {
                        r[t] = t * o + 6
                    }
                }
                return r
        ...
        U = function (r, n, t, o, e, a) {
            if (void 0 === e && (e = 1), void 0 === a && (a = 40), void 0 === o && (o = -1), void 0 === t && (t =
                !0), !(1 <= e && e <= a && a <= 40) || o < -1 || o > 7) {
                throw "Invalid value"
            }
